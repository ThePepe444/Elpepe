...
export default function ContactoPage() {
  const socialLinks = [
    {
      name: "WhatsApp",
      url: "https://api.whatsapp.com/message/N4ZUYZ5SK2MNE1?autoload=1&app_absent=0",
      icon: (
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/emanuelpulido.dev/",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Facebook",
      url: "https://www.facebook.com/ElPepe0444",
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center p-6 rounded-lg bg-background/50 backdrop-blur-sm border border-border">
              <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4">
               ...
               <p className="text-foreground/70">México</p>
            </div>
          </div>
        </ScrollAnimation>
